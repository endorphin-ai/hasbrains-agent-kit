# The 10 Usability Heuristics (H1-H10)

> **Source**: adapted from [tommyjepsen/awesome-ux-skills](https://github.com/tommyjepsen/awesome-ux-skills) (`ux-heuristics-review.md`).
> **Load when**: Running a heuristic critique or translating heuristics into design guidance — the H1-H10 reference, the per-input-type focus list, and the two run modes.
