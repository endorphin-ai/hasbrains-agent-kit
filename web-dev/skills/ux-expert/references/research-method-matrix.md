# UX Research Method Matrix

> **Source**: adapted from [tommyjepsen/awesome-ux-skills](https://github.com/tommyjepsen/awesome-ux-skills) (`ux-research-methods.md`).
> **Load when**: Choosing a research method — the three-dimension framework, the product-phase map, the 20-method table, and the traps.
