...
> **Source**: adapted from [tommyjepsen/awesome-ux-skills](https://github.com/tommyjepsen/awesome-ux-skills) (`ux-personas.md`).
> **Load when**: Building, improving, or critiquing personas — the research foundation rule, the required/optional field set, the relevance test, the output layout, the quality checklist.
