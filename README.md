...
| Plugin | What it does |
|---|---|
| [`agent-engineering`](agent-engineering) | Engineering discipline for AI agent systems. Four always-on principles, test-driven development, verification-before-completion, system-architecture playbooks, a scope-disciplined product manager (PRD → roadmap → acceptance gate), docs/-native project management, and Claude Code → GitHub Copilot agent conversion. |
